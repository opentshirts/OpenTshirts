...
class ControllerStudioForgotten extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('studio/forgotten', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/studio/forgotten.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/studio/forgotten.tpl';
		} else {
			$this->template = 'default/template/studio/forgotten.tpl';
		}
