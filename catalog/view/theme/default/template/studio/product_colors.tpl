<?php if($product_colors) : ?>
	<div align="center">
		<div align="center" onclick="$(this).parent().next().toggle(); $(this).children('span').toggleClass('ui-icon-circle-triangle-s ui-icon-circle-triangle-n');" class="ui-widget-content ui-corner-tl ui-corner-tr" style="cursor: pointer; padding: 10px 15px; display: inline-block; border-width: 1px 1px 0px 1px; top: -39px; white-space: nowrap;" ><?php echo $text_product_colors; ?><span style="display: inline-block; margin: 0 0 0 10px;" class="ui-icon ui-icon-circle-triangle-s"></span></div>
	</div>
	<div align="center">
	<div class="ui-widget-content ui-corner-tr ui-corner-bl ui-corner-br" style="overflow: auto; display: inline-block;">
		<ul>
