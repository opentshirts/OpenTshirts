  ...
  <div class="product-info">
    ...
    height: 42px; width: 41px; "></div>
        ...
        <div style="overflow: auto; margin: 20px 0px;">
          <div id="ot_title_text"><?php echo $text_sizes; ?></div>
          <table class="ot_sizes_table" cellspacing="0">
              <tr>
        ...
        <div style="overflow: auto; margin: 20px 0px;">
          <div id="ot_title_text"><?php echo $text_price; ?></div>
          <table class="ot_prices_table" cellspacing="0">
              <thead>
              <tr>
