package flex.utils.spark.resize {
	...
	public class ResizeManager extends EventDispatcher {
		...
		public function ResizeManager(resizeComponent:UIComponent = null, resizeHandle:UIComponent = null, resizeDirection:String = "both") {
			...
			this._bringToFrontOnResize = true;
			this._constrainToParentBounds = true;
			...
			if (okay) {
				...
				if (bringToFrontOnResize && resizeComponent.parent) {
					...
					if (index != last) {
						...
						var p:IVisualElementContainer = resizeComponent.parent as IVisualElementContainer;
						p.setElementIndex(resizeComponent,last);
					}
				}
