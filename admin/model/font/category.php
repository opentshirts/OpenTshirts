<?php
class ModelFontCategory extends Model {
	public function addCategory($data) {
		$query = $this->db->query('SELECT UUID()');
		$id_category = $query->row['UUID()'];
		
		$sql  = "INSERT INTO " . DB_PREFIX . "font_category SET ";
	...
	public function editCategory($id_category, $data) {
		$sql  = "UPDATE " . DB_PREFIX . "font_category SET ";
	...
	public function deleteCategory($id_category)
	{
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "font_category WHERE id_category = '" . $this->db->escape($id_category) . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "font_font_category WHERE id_category = '" .  $this->db->escape($id_category) . "' ");
	...
	public function getCategoriesByParentId($parent=false) {
		...
		$sql = "SELECT id_category, description FROM " . DB_PREFIX . "font_category ".$where." ORDER BY description ASC";
	...
	public function getCategory($id_category) {
		$sql = "SELECT * FROM " . DB_PREFIX . "font_category WHERE id_category='".$id_category."' ";
		$query = $this->db->query($sql);
		return $query->row;
	}
}
