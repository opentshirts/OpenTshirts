...
class ModelOpentshirtsCompositionCategory extends Model {
	...
	public function editCategory($id_category, $data) {
		$sql  = "UPDATE " . DB_PREFIX . "composition_category SET ";
	...
	public function deleteCategory($id_category)
	{
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "composition_category WHERE id_category = '" . $this->db->escape($id_category) . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "composition_composition_category WHERE id_category = '" .  $this->db->escape($id_category) . "' ");
