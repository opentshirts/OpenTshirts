<?php
class ModelClipartCategory extends Model {
	...
	public function editCategory($id_category, $data) {
		$sql  = "UPDATE " . DB_PREFIX . "clipart_category SET ";
	...
	public function deleteCategory($id_category)
	{
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "clipart_category WHERE id_category = '" . $this->db->escape($id_category) . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "clipart_clipart_category WHERE id_category = '" .  $this->db->escape($id_category) . "' ");
