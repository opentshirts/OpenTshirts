...
class ControllerOpentshirtsCompositionCategory extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('opentshirts/composition_category', 'token=' . $this->session->data['token'], 'SSL')); 
		}
	...
	private function getList() {
		...
		$this->data['categories'] = $this->recursiveCategories($this->model_opentshirts_composition_category->getCategoriesByParentId());
		
		$this->data['delete'] = $this->url->link('opentshirts/composition_category/delete', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['insert'] = $this->url->link('opentshirts/composition_category/insert', 'token=' . $this->session->data['token'] , 'SSL');
		...
		$this->template = 'opentshirts/composition_category_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm() {
		...
		if (!isset($this->request->get['id_category'])) {
			$this->data['action'] = $this->url->link('opentshirts/composition_category/insert', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$this->data['action'] = $this->url->link('opentshirts/composition_category/update', 'token=' . $this->session->data['token'] . '&id_category=' . $this->request->get['id_category'], 'SSL');
		}
		
		$this->data['cancel'] = $this->url->link('opentshirts/composition_category', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->template = 'opentshirts/composition_category_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function validateDelete() {
  	...
  	public function category_tab() {
		...
		$this->template = 'opentshirts/composition_category_tab.tpl';
