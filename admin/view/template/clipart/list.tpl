        ...
        <table class="list">
          <thead>
			<tr>
			  ...
			  <td class="right"><?php echo $column_id_clipart; ?></td>
          ...
          <tbody>
            <tr class="filter">
			  <td></td>
			  <td class="right"><input type="text" name="filter_id_clipart" value="<?php echo $filter_id_clipart; ?>" size="4" style="text-align: right;" /></td>
			  <td></td>
			...
			<?php if ($cliparts) { ?>
				...
				<tr>
				  <td style="text-align: center;"><?php if ($clipart['selected']) { ?>
				...
				<?php } ?></td>
				  ...
				  <td class="left"><ul><?php foreach ($clipart['categories'] as $category) { ?>
				<li><?php echo $category['description']; ?></li>
				<?php } ?></ul></td>
				<td class="left"><ul><?php foreach ($clipart['keywords'] as $keyword) { ?>
				...
				<?php } ?></ul></td>
				  ...
				  <td class="right"><?php foreach ($clipart['action'] as $action) { ?>
