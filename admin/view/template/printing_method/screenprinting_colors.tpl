	...
	<?php } else { ?>
		...
		<tr>
			...
			<?php if (!$color['isdefault']) { ?>
				...
				<input type="checkbox" name="data[screenprinting_colors][]" value="<?php echo $color['id_design_color']; ?>" checked="checked" />
				<?php } else { ?>
				<input type="checkbox" name="data[screenprinting_colors][]" value="<?php echo $color['id_design_color']; ?>" />
				<?php } ?>
			<?php } ?>
			</td>
