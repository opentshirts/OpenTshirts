...
<div class="box">
	<div align="center">
		<p>* <?php echo $text_no_whitebase; ?> | ** <?php echo $text_whitebase_1; ?> | *** <?php echo $text_whitebase_2; ?></p>
				...
				<li class="ui-widget-content">
					...
					<?php foreach($price as $area=>$array_quantity) { ?>
						<div style="white-space:nowrap; text-align: center" class="price row">
							<span><?php echo $symbol_left; ?> <input title="<?php echo $text_no_whitebase; ?>" type="text" style="width:45px; text-align: right" class="ui-widget-content ui-corner-all" data="price" name="price[<?php echo $area; ?>][]" value="<?php echo $price[$area][$index]; ?>" /> <?php echo $symbol_right; ?>*</span>
							<span><?php echo $symbol_left; ?> <input title="<?php echo $text_whitebase_1; ?>" type="text" style="width:45px; text-align: right" class="ui-widget-content ui-corner-all" data="price_1" name="price_1[<?php echo $area; ?>][]" value="<?php echo $price_1[$area][$index]; ?>" /> <?php echo $symbol_right; ?>**</span>
							<span><?php echo $symbol_left; ?> <input title="<?php echo $text_whitebase_2; ?>" type="text" style="width:45px; text-align: right" class="ui-widget-content ui-corner-all" data="price_2" name="price_2[<?php echo $area; ?>][]" value="<?php echo $price_2[$area][$index]; ?>" /> <?php echo $symbol_right; ?>***</span>
						</div>
					<?php } ?>
				</li>
				<?php } ?>
...
function addRow(area) {
    ...
    $("#matrix_list > li").each(function(index) {	
		...
		new_div.find('input[data=price_1]').attr('name','price_1['+ area +'][]');
		new_div.find('input[data=price_2]').attr('name','price_2['+ area +'][]');
	});
