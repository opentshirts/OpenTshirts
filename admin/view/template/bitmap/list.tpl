        ...
        <table class="list">
		  <thead>
			<tr>
			  ...
			  <td class="left"><?php if ($sort == 'b.name') { ?>
			  ...
			  <td class="right" nowrap="nowrap"><?php if ($sort == 'b.date_added') { ?>
		  ...
		  <tbody>
			<tr class="filter">
			  <td></td>
			  <td class="right"><input type="text" name="filter_id_bitmap" value="<?php echo $filter_id_bitmap; ?>" size="4" style="text-align: right;" /></td>
			  <td></td>
			...
			<?php if ($bitmaps) { ?>
				...
				<tr>
				  <td style="text-align: center;"><?php if ($bitmap['selected']) { ?>
				...
				<?php } ?></td>
				  ...
				  <td class="left"><ul><?php foreach ($bitmap['categories'] as $category) { ?>
				<li><?php echo $category['description']; ?></li>
				<?php } ?></ul></td>
				<td class="left"><ul><?php foreach ($bitmap['keywords'] as $keyword) { ?>
				...
				<?php } ?></ul></td>
				  ...
				  <td class="right"><?php foreach ($bitmap['action'] as $action) { ?>
